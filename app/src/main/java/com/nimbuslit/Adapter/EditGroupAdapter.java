...
public class EditGroupAdapter extends BaseAdapter implements Filterable {
    Activity activity;
    ...
    public EditGroupAdapter(@NonNull Activity context) {
        activity = context;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (convertView == null) {
            ...
            viewHolder.removeDevice.setOnClickListener(view -> showAlert("Are you sure ,Want to remove device from this group","Remove Device"));
        }
//        ViewHolder viewHolder = new ViewHolder(convertView);
